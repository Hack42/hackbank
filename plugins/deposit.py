...
class deposit:
    ...
    def input(self,text):
        if text=="deposit": 
            ...
            self.master.send_message(True,'message','How much do you want to deposit?')
    ...
    def value(self,text):
        try:
            ...
            if text=="abort":
                ...
                return True
            self.master.donext(self,'value')
            self.master.send_message(True,'message','Not a valid number! How much do you want to deposit?')
            self.master.send_message(True,'buttons',json.dumps({'special':'numbers'}))
            return True
