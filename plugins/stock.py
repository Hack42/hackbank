...
class stock:
    ...
    def help(self):
        return {"inkoop": "Report buying products", "voorraad": "Set stock of a product"}
    ...
    def voorraad(self,text):
        ...
        if prod:
             self.prod=prod
             self.master.donext(self,'voorraad_amount')
             self.master.send_message(True,'message','How much '+prod+' is in stock?')
             self.master.send_message(True,'buttons',json.dumps({'special':'numbers'}))
             return True
        elif text=="abort":
             self.master.callhook('abort',None)
             ...
             self.master.donext(self,'voorraad')
             self.master.send_message(True,'message','Unknown Product, what product to set the stock?')
             self.master.send_message(True,'buttons',json.dumps({'special':'products'}))
             return True
    ...
    def inkoop_amount(self,text):
        try:
             ...
             if text=="abort":
                 ...
                 self.master.donext(self,'inkoop_amount')
                 self.master.send_message(True,'message','Not a number, how much '+self.prod+' did you buy?')
                 self.master.send_message(True,'buttons',json.dumps({'special':'numbers'}))
                 return True
    ...
    def inkoop(self,text):
        ...
        if prod:
             self.prod=prod
             self.master.donext(self,'inkoop_amount')
             self.master.send_message(True,'message','How much '+self.prod+' did you buy?')
             self.master.send_message(True,'buttons',json.dumps({'special':'numbers'}))
             return True
        elif text=="abort":
             self.master.callhook('abort',None)
             ...
             self.master.donext(self,'inkoop')
             self.master.send_message(True,'message','Unknown Product, what product did you buy?')
             self.master.send_message(True,'buttons',json.dumps({'special':'products'}))
             return True
